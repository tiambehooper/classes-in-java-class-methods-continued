...
public class Example {
    ...
    public boolean not(boolean isHot){
        isHot = ! isHot;
    ...
    public int doublePlusOne(int num1){
    ...
    public double averageTwoNumbers(double num1, double num2 ){
        ...
        double averageTwoNumbers =  (num1 + num2)/2;

        return averageTwoNumbers;
     ...
     * - returns nothing
     *
     * This method should print out the greeting generated by the getGreemting()
